...
final class WishController extends AbstractController
{
    ...
    public function update(
        ...
        $this->addFlash('error', 'You can\'t modify this wish !');
        return $this->redirectToRoute('wish_show', ['id' => $wish->getId()]);
    }
    ...
    public function delete(int $id, WishRepository $wishRepository, EntityManagerInterface $em): Response
    {
        ...
        if ($this->getUser() !== $wish->getUser()) {
            $this->addFlash('error', 'You can\'t delete this wish !');
            return $this->redirectToRoute('wish_show', ['id' => $wish->getId()]);
        }
    ...
    #[IsGranted('ROLE_USER')]
    #[Route('/{id}/add-comment', name: 'comment', requirements: ['id' => '\d+'], methods: ['GET', 'POST'])]
    public function comment(int $id, Comment $comment, WishRepository $wishRepository, EntityManagerInterface $em): Response
    {
        $wish = $wishRepository->find($id);
